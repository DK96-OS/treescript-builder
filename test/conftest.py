...
DATA_TREE_TARGET_FILE_INSTRUCT_WITH_DATA = InstructionData(False, Path(f'./{DATA_TREE_TARGET_DIR_NAME}/{DATA_TREE_TARGET_FILE_NAME}'), Path(f'./{DATA_TREE_DATA_DIR_NAME}/{DATA_TREE_DATA_FILE_NAME}'))
